...
<pre>
MSSV: 2021050233  Họ và tên:  Bùi Phúc Hải
</pre>

Phân công công việc:

- Phân tích dữ liệu, build model DNN, train model logistic, bình luận, dự đoán
- Thu thập dữ liệu API, crawl dữ liệu qua HTML, tiền xử lý và xử lý dữ liệu,  train model linear, train model logistic, dự đoán
